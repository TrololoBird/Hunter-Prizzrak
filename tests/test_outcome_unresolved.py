...
Замер по 3672 записям истории ДО правки: `timeout` — 1020 сделок (**28% всех**), и 775 из них
(76%) уходили в победы по НЕЗАКРЫТОЙ бумажной прибыли. Больше четверти «статистики» состояла из
позиций, которые ничего не доказали.

ПОСЛЕ правки на той же истории: win 61.5% · unresolved 29.8% · loss 8.7%. Винрейт по
РАЗРЕШЁННЫМ сделкам — 87.6%, но выборка сжалась с 3659 до 2589 (70%). Число выросло, а доверия
к нему стало БОЛЬШЕ: теперь оно про сделки, которые действительно дошли до барьера.
