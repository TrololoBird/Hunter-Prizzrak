...
RU-метку в карточке (format_post.SETUP_KIND_RU). Иначе в Telegram падает сырой id (F1: figure_pennant_6touch так и
...
from hunt_core.prizrak.format_post import SETUP_KIND_RU
...
def test_figure_pennant_6touch_is_labelled() -> None:
    ...
    assert "figure_pennant_6touch" in SETUP_KIND_RU
