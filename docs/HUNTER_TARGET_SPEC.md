...
✅ закрыто **22** из 30, ◐ частично **3** (G-14, G-21, G-23), ⬜ открыто **5**
(G-26…G-30 — механический техдолг, нулевое влияние на сигнал).
**P0 закрыт полностью** (все 14 сигнал-искажающих). P1 закрыт, кроме хвоста сирот
в G-23. Гейт: ruff чисто, mypy 190 файлов, **368/368 pytest** (+19 новых
пиннинг-тестов), удалено 16 мёртвых файлов.
...
фантом-ключи → CHoCH не детектился НИКОГДА. Отсюда правило §5 и инвариант I-6.
