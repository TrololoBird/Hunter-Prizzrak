...
**Статус на 2026-07-14 (ветка `push-snapshot`, коммиты `12b990d..153bb2b`):**
✅ закрыто **10** из 30 (включая все «сигнал-ломающие» контракт-баги),
◐ частично **2** (G-14, G-21), ⬜ открыто **18**. Гейт после правок: ruff чисто,
mypy 190 файлов, **356/356 pytest** (+7 новых пиннинг-тестов), удалено 16 мёртвых
файлов. Из закрытых 8 — P0 (сигнал-искажающие).
