...
BASELINE: list[dict[str, Any]] = [
    ...
    {
        # Обзор Pavel M «BTC + ETH — открытие рынков, календарь на неделю и новые сделки»
        # (2026-07-27, TradingView UEx9XJ03 + видео 54:19). Подписи сняты с ЕГО графика 1ч
        # (кадр 14:38:12 UTC, цена 64 902,3) и сверены с опубликованным скрином 4ч.
        # Он сам называет диапазон решений: «Ключевые уровни на данный момент — 1-4ч (основные)».
        "symbol": "BTC/USDT:USDT", "date": "2026-07-27", "src": "overcarder_btc_2026-07-27",
        "levels": [
            (68450.0, "🔴 верх шорт-зоны в перезакуп"), (67860.0, "🔴 низ шорт-зоны"),
            (67130.0, "🟡 верх шорта на ретест"), (66850.0, "✅ отработавший шорт"),
            (66610.0, "🟡 низ шорта на ретест"), (66310.0, "серая"), (65950.0, "серая"),
            (64490.0, "уровень забран — пропускает"), (64070.0, "🟡 локальная"),
            (63600.0, "🟡 верх локальных"), (63400.0, "🟡 низ локальных"),
            (63140.0, "🟢 верх лимиток (2-й ПОК структуры)"), (62850.0, "🟢 ПОК структуры"),
            (62010.0, "🟢 верх глубокого добора"), (61550.0, "🟢 низ глубокого добора"),
        ],
    },
    {
        # Тот же обзор, вкладка ETH (кадр 14:47:12 UTC, цена 1 927,52).
        # ⚠ 1662–1700 — «сетка ПОД ПРОКОЛ под базой», он ставит её ЗАРАНЕЕ и НИЖЕ структуры,
        # на случай сквиза. Ни один наш горизонт такого объекта не порождает: карта строится
        # от боксов накопления, а эта сетка живёт под их полом. Оставлена в эталоне намеренно —
        # как измеримый счёт того, чего модуль не умеет (см. разбор в prizrak_corpus).
        "symbol": "ETH/USDT:USDT", "date": "2026-07-27", "src": "overcarder_eth_2026-07-27",
        "levels": [
            (2173.0, "жёлтая верх"), (2121.0, "🔴 красная"), (2074.0, "🔴 верх лимиток"),
            (2060.0, "🔴 низ лимиток"), (2014.0, "🟡 по факту"), (1987.0, "✅ шорт взят утром"),
            (1914.0, "тест — пропускает"), (1883.0, "🟡 добор при сужении"),
            (1858.0, "🟡 верх нижнего добора"), (1844.0, "🟡 низ нижнего добора"),
            (1804.0, "🟢 верх ключевой поддержки"), (1785.0, "🟢 середина (разбил на 2)"),
            (1771.0, "🟢 низ ключевой поддержки"), (1741.0, "жёлтая"),
            (1700.0, "🟡 верх сетки под прокол"), (1662.0, "🟡 низ сетки под прокол"),
        ],
    },
    {
