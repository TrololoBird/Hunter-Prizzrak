...
def close_signal(
    ...
    *,
    ...
    if exit_price is not None and exit_price > 0:
        ...
        #
        # ЗАМЕР по 3682 записям истории: 88.5% зон вырождены (нулевая ширина), там разницы нет.
        # Но у остальных 423 медиана ширины 1.010%, p90 3.547%, максимум 13.26% — то есть до
        # **6.63%** фантомной прибыли на сделку. Не «мелочь, которой можно пренебречь»: это
        # больше, чем весь буфер стопа.
        #
