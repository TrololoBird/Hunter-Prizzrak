...
# Layer 1: transport ping-pong — PROJECT ccxt async ws/client.py (keepAlive × maxPingPongMisses).
PING_KEEPALIVE_MS: int = 5000  # ×2 misses ≈ 10s dead-socket detection (free in ccxt.pro)
