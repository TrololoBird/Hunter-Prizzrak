...
# ТФ, на которых считаются дорогие «богатые» метрики (трендовая по RSI, скрытые дивергенции).
# 1д добавлен по разбору BTC 1ч от 2026-07-25: трендовую он рисует ИМЕННО на дневной панели RSI —
# кадры f_0234–f_0237, восходящая от RSI-минимума 06 июня через июльский, третье касание впереди
