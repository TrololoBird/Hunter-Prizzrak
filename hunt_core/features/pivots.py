...
def _pivot_rows(
    ...
    *,
    ...
    ⚠️ ``max_lookback`` НЕ откалиброван и на живых данных НЕ СРАБАТЫВАЕТ. Он пришёл первым же
    коммитом репозитория без замера и без обоснования, и выглядит настроенным порогом, не будучи им.
